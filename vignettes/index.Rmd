...
# Introduction to the nbc4va Package

The nbc4va package implements the Naive Bayes Classifier (NBC) algorithm for verbal autopsy data based on code and methods provided by [Miasnikof et al (2015)](http://bmcmedicine.biomedcentral.com/articles/10.1186/s12916-015-0521-2).
...
The nbc4va package implements the NBC algorithm for verbal autopsy data using code and methods built on [Miasnikof et al (2015)](http://bmcmedicine.biomedcentral.com/articles/10.1186/s12916-015-0521-2).
...
**PCCC**: partial chance corrected concordance [(Murray et al 2011)](http://pophealthmetrics.biomedcentral.com/articles/10.1186/1478-7954-9-28).
...
**CSMFmaxError**: cause specific mortality fraction maximum error [(Murray et al 2011)](http://pophealthmetrics.biomedcentral.com/articles/10.1186/1478-7954-9-28).
...
**CSMFaccuracy**: cause specific mortality fraction accuracy \href{http://pophealthmetrics.biomedcentral.com/articles/10.1186/1478-7954-9-28}{(Murray \emph{et al} 2011)}.
...
* Miasnikof P, Giannakeas V, Gomes M, Aleksandrowicz L, Shestopaloff AY, Alam D, Tollman S, Samarikhalaj, Jha P. Naive Bayes classifiers for verbal autopsies: comparison to physician-based classification for 21,000 child and adult deaths. BMC Medicine. 2015;13:286. doi:10.1186/s12916-015-0521-2.
* Murray CJL, Lozano R, Flaxman AD, Vahdatpour A, Lopez AD. Robust metrics for assessing the performance of different verbal autopsy cause assignment methods in validation studies.Popul Health Metr. 2011;9:28. doi:10.1186/1478-7954-9-28.
